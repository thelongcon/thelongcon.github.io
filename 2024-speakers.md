        ...
        <tbody>
          ...
          <tr>
            <td>16:30 - 17:00</td>
              ...
              <td>
                <a href="#adam">State machines & security</a>
                <br/>
                Adam
              </td>
...
Personally, I avoid computers and enjoy punishing myself with manual labour and farm work, reading a good book, or reading about Linguistics."</p>
  ...
  <div class="row" style="padding-top:3em;" id="adam">
    <div class="col-lg-12 bg-primary">
      <h4 class="title">State machines & security</h4>
      <h5 class="speaker">Adam</h5>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-7">
      <p class="abstract">This talk will go over some common security mistakes when implementing stateful communication protocols. To keep things interesting, we'll use interactive examples to explore the coding mistakes. The mistakes will start with some newbie blunders and then move into more subtle and hard to catch issues. It will also provide a number of techniques to help tame code complexity with state machine visualizations making it easier to spot gaps in code.</p>
